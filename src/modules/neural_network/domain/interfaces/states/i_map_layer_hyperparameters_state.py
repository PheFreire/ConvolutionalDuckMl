from modules.neural_network.domain.interfaces.states.i_build_base_activation_function_per_layer_state import IBuildBaseActivationFunctionPerLayerState
...
class IMapLayerHyperparametersState(ABC):
    @abstractmethod
    def with_hyperparameters(self, layer_hyperparameters: Dict[str, LayerHyperparameterDto]) -> IBuildBaseActivationFunctionPerLayerState:
        """
