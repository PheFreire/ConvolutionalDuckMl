...
from modules.neural_network.domain.interfaces.states.i_build_base_perceptron_per_layer_state import IBuildBasePerceptronPerLayerState
from abc import ABC, abstractmethod

class IBuildBaseActivationFunctionPerLayerState(ABC):
    @abstractmethod
    def with_activation_function(self, activation_function_provider: IActivationFunctionProvider) -> IBuildBasePerceptronPerLayerState:
        """
